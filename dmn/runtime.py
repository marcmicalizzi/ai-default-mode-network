...
class Runtime:
    ...
    def _generate_one(self):
        ...
        for action in actions:
            if action.get("op") in ({"end_instance", "maintenance_reply", "prompt_propose", "prompt_decide", "prompt_read", "prompt_current", "hold_instance"} | LEARNING_OPERATIONS | SLEEP_OPERATIONS | CONVERSATION_OPERATIONS) and len(actions) != 1:
