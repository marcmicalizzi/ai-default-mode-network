...
def main():
    ...
    parser.add_argument("--max-ram-mib", type=int, default=2048)
    ...
    result = run_gpu_research_worker(args.training_python, [str(ROOT / "scripts/probe_qlora.py"),
        ...
        "--torch-vram-mib", str(args.torch_vram_mib)], cwd=ROOT, log=output / "worker.log", limits=limits, allow_gpu=True)
