...
Compact Gemma4 tests additionally use `DMN_TEST_SWA_MODEL`, pointing to the tiny
random fixture generated by `scripts/generate_swa_fixture.py`. The ordinary CI
suite does not require either model or native bindings.
