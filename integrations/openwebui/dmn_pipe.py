...
class Pipe:
    async def pipe(self, body: dict, __request__, __metadata__: dict = None, __task__=None, __event_emitter__=None):
        if __task__:
        ...
        event_id = await bridge.submit(__metadata__ or {})
        if __event_emitter__:
            await __event_emitter__({"type": "status", "data": {
                "description": "Delivered to DMN. It may respond independently.", "done": True,
